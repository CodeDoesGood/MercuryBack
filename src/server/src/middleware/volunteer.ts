...
export async function createPasswordResetCode(req: Request, res: Response, next: NextFunction) {
  ...
  try {
    const passwordResetCode: number | Error = await volunteer.createPasswordResetCode();
...
export async function validatePasswordResetCodeAuthenticity(req: Request, res: Response, next: NextFunction) {
  ...
  try {
    const passwordResetCode: IPasswordResetCode | Error | any = await volunteer.getPasswordResetCode();
...
export async function createNewVolunteer(req: Request, res: Response, next: NextFunction) {
  ...
  try {
    const verificationCode: number | Error = await volunteer.create(vol.password, 1);
...
export async function markNotificationAsRead(req: Request, res: Response) {
  ...
  try {
    const exist = await volunteer.exists();
